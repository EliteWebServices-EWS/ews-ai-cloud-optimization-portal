...
For the evidence and governance decision-readiness baseline, including the preserved commercial controls and Sprint 2 evidence-maturity ADR input, see [docs/architecture/sprint-1-evidence-governance-mapping.md](docs/architecture/sprint-1-evidence-governance-mapping.md).
